...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="article">
        <div style="background-position: left;">
            <h2><b>Administrar Anuncios</b></h2><br />
                        ...
                        <td rowspan="4">                 
                            <table style="width:100%;">
                                <tr>
                                    ...
                                    <td width="30%">
                                        <asp:TextBox ID="txtRazonSocial" runat="server" Enabled="False" Width="200px" 
                                            CssClass="campo-field"></asp:TextBox>
                                        </td>
                                    <td width="20%"><b>
                <asp:Label ID="lblUsuario" runat="server" CssClass="failureNotification"></asp:Label></b></td>
                                    <td width="35%">
                                        &nbsp;</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTitulo" runat="server" Enabled="False" Width="200px" 
                                            CssClass="campo-field" ></asp:TextBox>
                                ...
                                <tr>
                                    <td colspan="3" rowspan="4">
                                        <asp:TextBox ID="txtDescripcion" runat="server" Height="100px" 
                                            TextMode="MultiLine" Width="500px" CssClass="campo-field" Enabled="False"></asp:TextBox>
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
    ...
    <div class="article">
        <table style="width: 100%;" align="center" class="ic_container">
            <tr>
                ...
                <td align="center">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="titulo" HeaderText="Título del  Anuncio" />
