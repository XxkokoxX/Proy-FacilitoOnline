<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.master" AutoEventWireup="true" CodeFile="MantenimientoOfertas.aspx.cs" Inherits="MantenimientoUsuario" %>
                    ...
                    <tr>
                        <td style="border-right: 1px dotted silver;width: 165px; height: 45px;">
                            ...
                            <asp:Button ID="btnGrabar" 
                                ...
                                ToolTip="Clic aqui para grabar." ValidationGroup="RegOfertValidationGroup" 
                                CssClass="yellow button" />
                        </td>
                    </tr>
                    <tr>
