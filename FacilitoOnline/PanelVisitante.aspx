<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.master" AutoEventWireup="true" CodeFile="PanelVisitante.aspx.cs" Inherits="PanelDeCuenta" %>
                            ...
                            <div class="dashboard-site-more-options-area " id="site-extra-config-345969" style="display: ;">
                                <div class="dashboard-site-extra-config-item float-left ">
                                    <div class="dashboard-site-extra-config-item-title dashboard-extra-config-pro-account ">
                                        <a class=" open-bligoo-window-link " href="ActualizarDatosVisitante.aspx" data-method="windowProAccount" data-name="windowproaccount" data-parameters="{&#39;blogId&#39;:&#39;345969&#39;}" data-height="130" data-width="400" data-module="ContactForm">Actualizar datos Personales</a>
                                    </div>
                                    <div class="dashboard-site-extra-config-item-desc ">
                                        <p>Realizar algún cambio en mi información personal .</p>
                                ...
                                <div class="dashboard-site-extra-config-item float-left ">
                                    <div class="dashboard-site-extra-config-item-title dashboard-extra-config-site-newsletter ">
                                        <a class=" open-bligoo-window-link " href="CambiarContraseñaVisitante.aspx" data-method="windowGoToNewsletter" data-name="windowgotonewsletter" data-parameters="{&#39;blogId&#39;:&#39;345969&#39;}" data-height="450" data-width="400" data-module="CMR">Cambiar Contraseña</a>
                                    </div>
                                    <div class="dashboard-site-extra-config-item-desc ">
                                        <p>Actualizar mi contraseña.</p>
                                ...
                                <div class="dashboard-site-extra-config-item float-left ">
                                    <div class="dashboard-site-extra-config-item-title dashboard-extra-config-google-apps ">
                                        <a class=" open-bligoo-window-link " href="javascript:void(0)" data-method="windowGoogleApps" data-name="windowgoogleapps" data-parameters="{&#39;blogId&#39;:&#39;345969&#39;}" data-height="350" data-width="500" data-module="Shop">Detectar clientes</a>
                                    </div>
                                    <div class="dashboard-site-extra-config-item-desc ">
                                        <p>Ubicar clientes cerca de mi posición.</p>
                                    </div>
                                </div>
                                ...
                                <div class="clear "></div>
                                <div class="dashboard-site-extra-config-item-delete " id="dashboard-site-extra-config-item-delete"><a class=" open-bligoo-window-link " href="javascript:void(0)" data-method="windowDeleteSite" data-name="delete-site" data-parameters="{&#39;blogId&#39;:&#39;345969&#39;}" data-height="500" data-width="400" data-module="Blog">Panel de Control.</a> Zona de Visitante</div>
                                <div class="clear "></div>
                            </div>
                        </td>
                    </tr>
