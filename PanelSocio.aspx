<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.master" AutoEventWireup="true" CodeFile="PanelSocio.aspx.cs" Inherits="PanelDePreferencias" %>
                        ...
                        <td class="site-url ">
                            <div class="site-row ">
                                <div class="site-basic-info ">
                                    <strong>Dar un vistazo</strong>&nbsp;<a class=" site-go-link dont-open " href="#" title="Abrir este sitio en una ventana nueva">Ver &#8594;</a>
                                    <div class="clear "></div>
                                </div>
                            ...
                            <div class="dashboard-site-more-options-area " id="site-extra-config-345969" style="display: ;">
                                ...
                                <div class="dashboard-site-extra-config-item float-left ">
                                    <div class="dashboard-site-extra-config-item-title dashboard-extra-config-site-newsletter ">
                                        <a class=" open-bligoo-window-link " href="MantenimientoCategorias.aspx" data-method="windowGoToNewsletter" data-name="windowgotonewsletter" data-parameters="{&#39;blogId&#39;:&#39;345969&#39;}" data-height="450" data-width="400" data-module="CMR">Gestionar Categorías</a>
                                    </div>
                                    <div class="dashboard-site-extra-config-item-desc ">
                                        <p>Registrar, actualizar y eliminar categorías de productos.</p>
                                ...
                                <div class="dashboard-site-extra-config-item float-left ">
                                    <div class="dashboard-site-extra-config-item-title dashboard-extra-config-domain-site ">
                                        <a class=" open-bligoo-window-link " href="MantenimientoServicios.aspx" data-method="windowDashboardDomainChange" data-name="windowdashboarddomainchange" data-parameters="{&#39;blogId&#39;:&#39;345969&#39;}" data-height="350" data-width="400" data-module="Blog">Gestionar Servicios</a>
                                    </div>
                                    <div class="dashboard-site-extra-config-item-desc ">
                                        <p>Registrar, actualizar y eliminar productos de la aplicación.</p>
                                    </div>
                                </div>

                                <div class="dashboard-site-extra-config-item float-left ">
                                    <div class="dashboard-site-extra-config-item-title dashboard-extra-config-site-removeads ">
                                        <a href="MantenimientoAnuncios.aspx">Gestionar Anuncios</a></div>
                                    <div class="dashboard-site-extra-config-item-desc ">
                                        <p>Registrar, actualizar y eliminar anuncios(fotos,videos,etc) de la aplicación</p>
                                ...
                                <div class="dashboard-site-extra-config-item float-left ">
                                    <div class="dashboard-site-extra-config-item-title dashboard-extra-config-google-apps ">
                                        <a class=" open-bligoo-window-link " href="MantenimientoEventos.aspx" data-method="windowGoogleApps" data-name="windowgoogleapps" data-parameters="{&#39;blogId&#39;:&#39;345969&#39;}" data-height="350" data-width="500" data-module="Shop">Gestionar Eventos</a>
                                    </div>
                                    <div class="dashboard-site-extra-config-item-desc ">
                                ...
                                <div class="dashboard-site-extra-config-item float-left ">
                                    <div class="dashboard-site-extra-config-item-title dashboard-extra-config-theme-edit ">
                                        <a class=" open-bligoo-window-link " href="MantenimientoSucursales.aspx" data-method="windowDashboardThemeEdit" data-name="windowdashboardthemeedit" data-parameters="{&#39;blogId&#39;:&#39;345969&#39;}" data-height="120" data-width="400" data-module="Blog">Gestionar Sucursales</a>
                                    </div>
                                    <div class="dashboard-site-extra-config-item-desc "><p>Registrar, actualizar y eliminar sucursales de la empresa .</p></div>
                                </div>
