<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.master" AutoEventWireup="true" CodeFile="ConsultarOfertas.aspx.cs" Inherits="ReporteOfertas" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="line"></div> 
    <div class="article">
        <div style="background-position: left;">
            <h2><b>Consultar Ofertas</b></h2><br />
    ...
    <div class="article">
        <table style="width: 100%;" class="ic_container">
            <tr>
                <td align="center"><h3><b>Consultar Ofertas</b></h3></td>
            </tr>
            <tr>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="precioActual" DataFormatString="{0:c}" 
                                HeaderText="Precio Real">
                            <ItemStyle BackColor="#6699FF" />
                            </asp:BoundField>
                            <asp:BoundField DataField="precioOferta" DataFormatString="{0:c}" 
