<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.master" AutoEventWireup="true" CodeFile="PanelInvitado.aspx.cs" Inherits="PanelDePreferencias" %>
                            ...
                            <div class="dashboard-site-more-options-area " id="site-extra-config-345969" style="display: ;">
                                ...
                                <div class="dashboard-site-extra-config-item float-left ">
                                    <div class="dashboard-site-extra-config-item-title dashboard-extra-config-theme-edit ">
                                        <a class=" open-bligoo-window-link " href="ConsultarComentarios.aspx" data-method="windowDashboardThemeEdit" data-name="windowdashboardthemeedit" data-parameters="{&#39;blogId&#39;:&#39;345969&#39;}" data-height="120" data-width="400" data-module="Blog">Ver Comentarios</a>
                                    </div>
                                ...
                                <div class="dashboard-site-extra-config-item float-left ">
                                    ...
                                    <div class="dashboard-site-extra-config-item-desc ">
                                        <p>Realizar algún cambio en la información de mi empresa.</p>
                                        <div class="dashboard-site-pro-badge  "><a>SOCIO</a></div>
                                    </div>
                                </div>
